		...
		<div className="max-w-4xl w-full">
			...
			<form onSubmit={handdleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-y-6 md:gap-x-10">
				...
				<div className="h-full">
					...
					<InputImage stateSetter={setThumbnail} className={`${theme == "dark" ? "bg-[#3B3B3B]" : "bg-white"} w-full h-[24.1ch] leading-[24.1ch] rounded-lg`} text="click atau Drag'n Drop Gambar" />
				</div>
	...
	return (
		<div className="max-w-4xl w-full">
			...
			<Form method="post" className="grid grid-cols-1 md:grid-cols-2 gap-y-6 md:gap-x-10">
				...
				<div className="h-full">
					<label className="block text-base-content/90 text-sm" htmlFor="thumbnail-project">Thumnail Project</label>
					<InputImage name="thumbnail-project" stateSetter={setImage} className={`${theme == "dark" ? "bg-[#3B3B3B]" : "bg-white"} w-full h-[24.1ch] leading-[24.1ch] rounded-lg`} fallbackImagePreview={data.thumbnail} text="click atau Drag'n Drop Gambar" />
				</div>
   ...
   return (
      <main style={{fontSize: 'clamp(14px, 2vw, 16px)'}}>
			...
			<div className="w-full bg-base-200 rounded-box min-h-screen p-4">
				...
				<div className='grid grid-cols-1 [@media_only_screen_and_(min-width:_550px)]:grid-cols-2 gap-4 lg:hidden'>
					{exampleData.map((el, ix) => {
						return (
