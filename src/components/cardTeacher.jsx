					...
					<div key={item.id}>
						<div className="w-fit pl-5 pt-5">
							<div
								...
								onClick={() =>
									document
										.getElementById(`detail-guru-${item.id}`)
										.showModal()
								}
								className="group hover:-translate-y-1 hover:shadow-lg transition-[shadow_transform]  duration-300 cursor-pointer relative w-80 h-28 bg-base-300/30 rounded-xl"
							>
								...
								<div className="pointer-events-none overflow-hidden rounded-[inherit] relative h-full">
									<div className="ml-20 pt-4 pr-6 mb-auto z-10">
										...
										<p className="text-current/50 text-sm">
											{item.jabatan}
										</p>
									</div>
									...
									<LazyMotion features={domAnimation}>
										<m.div
											style={{
												background:
													"radial-gradient(cyan, transparent 50%)",
												x,
												y,
											}}
